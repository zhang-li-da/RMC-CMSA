#!/usr/bin/env python3
"""Unified experiment driver for the RMC-CMSA revision studies.

Runs the frozen four-component RMC-CMSA implementation directly (imported
from the extracted release bundle) under configurable:

- causal controls (ablation): full / no_trajectory_evidence /
  no_terminal_memory / no_relations / no_maximin
...
FIELDS = [
    ...
    "rpr", "f1", "score", "precision", "n_sol", "used_eval", "elapsed_sec",
